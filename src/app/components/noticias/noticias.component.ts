...
export class NoticiasComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let url='https://api.eluniverso.arcpublishing.com/feeds/rss/?website=el-universo&query=taxonomy.sections._id:%22/larevista/ecologia%22&sort=first_publish_date:desc'
    fetch(proxy+url)
